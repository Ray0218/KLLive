...
//加class表示当前协议只能被类遵守
protocol KLMenueTitleDelegate : class {
    
    func titleViewChange(_ titleView : KLMenueTitleView, index: Int)
    
}

class KLMenueTitleView: UIView {
    ...
    var rStyle  : KLMenueTitleStyle
    
    weak  var delegate : KLMenueTitleDelegate?
    ...
    init(frame: CGRect, titles: [String], style: KLMenueTitleStyle) {
...
extension KLMenueTitleView: KLContentDelegate{
